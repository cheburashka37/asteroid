...
void Scene3D::drawFigure()
{
    glEnableClientState(GL_VERTEX_ARRAY);
    glEnableClientState(GL_COLOR_ARRAY);
    // Olga if you want to use textures add glEnableClientState(GL_TEXTURE_COORD_ARRAY) https://docs.microsoft.com/en-us/windows/desktop/opengl/glenableclientstate
